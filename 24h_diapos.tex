...
\vspace{2cm}
& \includegraphics[width=.6\textwidth, trim=200 0 170 30,clip]{Exports/Plan_24h_43eme-ERP_Dimanche}\\
\end{tabular}
...
& \includegraphics[width=.55\textwidth, trim=200 0 170 30,clip]{Exports/Plan_24h_43eme-Dimanche_IS}\\
\end{tabular}
...
\begin{itemize}
\item Campus fermé à la circulation du vendredi 18h au dimanche lundi 00h
\item Mise en place de points de contrôle
\item Distributions de laissez-passer à l'avance
\end{itemize}
\centering\includegraphics[width=\textwidth, trim=0 0 0 100,clip]{Exports/Plan_24h_43eme-Points_Secu}
...
\begin{itemize}
\item 6 points d'accès au campus
\item 2 points condamnés par des blocs en béton
\item Binômes de bénévoles 24h/24 pour vérifier les laissez-passer
\item Liaison radio avec le PC Sécurité
\end{itemize}
\centering\includegraphics[width=\textwidth, trim=0 0 0 100,clip]{Exports/Plan_24h_43eme-Points_Secu}
...
\frametitle{Dispositif soirée (1/2)}
\begin{itemize}
\item Renforcement du "dispositif journée" entre 20h et 5h les vendredi et samedi soir
\item Présence de deux AS
\item Présence d'un véhicule en travers de la route
\item Blocs en béton et barrières aux alentours pour empêcher un contournement
\item Restriction très forte de la circulation (même avec laissez-passer)
\end{itemize}
\centering\includegraphics[width=.6\textwidth, trim=0 0 0 0,clip]{Images/Points_secu}
...
\begin{itemize}
\item L’identité du conducteur sera contrôlée
...
\begin{itemize}
\item Nouvelle Grande Scène
\vspace{1cm}
\item Changement d'emplacement du PC Sécu et du PCO
\vspace{1cm}
\item Condamnation d'un PS supplémentaire
\vspace{1cm}
\end{itemize}
